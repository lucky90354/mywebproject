...
<!-- ==================================== class="form-group"> ===================== -->
                        <div class="form-group">
                                <div class="col-lg-4">
                                    ...
                                    <select name="student_name" class="form-control" onchange="showUser(this.value)">
                                    ...
                                    <?php
                                        ...
                                        $sel=mysql_query("SELECT DISTINCT `student_name` FROM `fees_monthly`") or die(mysql_error());
            ...
            <form action="get_databy_date.php" method="post">
                            ...
                            <div class="col-lg-3">
                                 <label>Start Date</label>
                                    <input type='text' name="sdate" class="form-control" placeholder="YYYY/MM/DD">  
                            </div>


                             <div class="col-lg-3">
                                        <label>End Date</label>
                                    <input type="text" name="ndate" class="form-control" placeholder="YYYY/MM/DD">
                            </div><br>
                        <div class="col-lg-2">
