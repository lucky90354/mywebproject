...
<title>Holiday Crown | Best hotel in India</title>
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav">        
        ...
        <li><a href="rooms-tariff1.php">Rooms & Tariff</a></li>        
        <li><a href="introduction1.php">Introduction</a></li>
        ...
        <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Welcome:
            <?php 
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="booked.php"><i class="fa fa-user fa-fw"></i>Booked Rooms</a>
                        </li>
