    ...
    <div class="welcome-message">
        <div class="wrap-info">
            <div class="information">
                ...
                <p class="animated fadeInUp">Most luxurious hotel of India with the royal treatments and excellent customer service.</p>                
            </div>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-4">
            ...
            <!-- RoomCarousel-->
            <div class="caption">Photos<a href="gallery.php" class="pull-right"><i class="fa fa-edit"></i></a></div>
        </div>
